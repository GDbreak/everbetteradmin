...
{
    /// <summary>
    /// The detailed resource for all Survey Questions.
    /// </summary>
    public class Survey_QuestionDetailsResource
    {
        /// <summary>
        ...
        /// <summary>
        /// The pre-defined responses for multiple choice questions.
        /// </summary>
        public IEnumerable<Survey_ResponseResource> Survey_Responses { get; set; }
    }
}
