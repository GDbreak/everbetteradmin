...
{
    /// <summary>
    /// The detailed resource for all Schedules.
    /// </summary>
    public class ScheduleDetailsResource
    {
        /// <summary>
        ...
        /// <summary>
        /// Whether the schedule is overlapping with another active schedule.
        /// </summary>
        ...
        /// <summary>
        /// The detailed resource of the clinician who the schedule is for.
        /// </summary>
        public ClinicianDetailsResource Clinician { get; set; }
    }
}
