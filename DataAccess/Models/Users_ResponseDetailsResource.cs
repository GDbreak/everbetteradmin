...
{
    /// <summary>
    /// The detailed resource for all User Responses.
    /// </summary>
    public class Users_ResponseDetailsResource
    {
        /// <summary>
        ...
        /// <summary>
        /// The survey response that was used to answer the question, when applicable.
        /// </summary>
        public Survey_ResponseResource Survey_Response { get; set; }
        /// <summary>
        /// The survey question that answered.
        /// </summary>
        public Survey_QuestionResource Survey_Question { get; set; }
    }
}
